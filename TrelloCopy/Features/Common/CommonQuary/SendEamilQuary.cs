...
namespace TrelloCopy.Features.Common.CommonQuary
{
    public record SendEamilQuary(string email, string name, string confirmationLink) : IRequest<RequestResult<bool>>;

    public class SendEmailQuaryHandler : BaseRequestHandler<SendEamilQuary, RequestResult<bool>>
    {

       readonly MailSettings mailSettings;
        public SendEmailQuaryHandler(BaseRequestHandlerParameters parameters, IOptions<MailSettings> _mailSettings) : base(parameters)
        {
