...
{
    public ReSendRegistrationEmailCommandHandler(BaseWithoutRepositoryRequestHandlerParameter<User> parameters) : base(parameters)
    {
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var emailSent = await _mediator.Send(new SendEamilQuary(RegisterationData.data.Email, RegisterationData.data.Name, confirmationLink));
