...
public class ChangePasswordCommandHandler : UserBaseRequestHandler<ChangePasswordCommand, RequestResult<bool>>
{
    public ChangePasswordCommandHandler(UserBaseRequestHandlerParameters parameters) : base(parameters)
    {
    }
    ...
    public async override Task<RequestResult<bool>> Handle(ChangePasswordCommand request, CancellationToken cancellationToken)
    {
        ...
        user.Password = newPassword;
         await _userRepository.SaveIncludeAsync(user,"Password");
